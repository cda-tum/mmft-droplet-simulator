...
class Fluid {
  private:
    ...
    double viscosity;                 ///< Dynamic viscosity of the continuous phase in Pas.
    double density;                   ///< Density of the continuous phase in kg/m^3.
  ...
  public:
     ...
     */
    Fluid(int id, double viscosity, double density, double concentration);
